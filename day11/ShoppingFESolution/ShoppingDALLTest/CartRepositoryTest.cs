...
namespace ShoppingDALTest
{
    public class CartRepositoryTest
    {
        ...
        public void Setup()
        {
            ...
            Customer customer = new Customer() { CustomerId = 101, Age = 25, Phone = "1234556789" };
            CartItem cartItem = new CartItem() { CartId = 1 };
            List<CartItem> cartItems = new List<CartItem>() { cartItem };
            Cart cart = new Cart() { CartId = 1, Customer = customer, CustomerId = 101, TotalPrice = 100, CartItems = cartItems };
            repository.Add(cart);
        ...
        {
            Customer customer = new Customer() { CustomerId = 102, Age = 25, Phone = "1234556789" };
            CartItem cartItem = new CartItem() { CartId = 2 };
            List<CartItem> cartItems = new List<CartItem>() { cartItem };
            Cart cart = new Cart() { CartId = 2, Customer = customer, CustomerId = 102, TotalPrice = 100, CartItems = cartItems };
        ...
        public void AddFailTest()
        {
            ...
            CartItem cartItem = new CartItem() { CartId = 2 };
            List<CartItem> cartItems = new List<CartItem>() { cartItem };
            Cart cart = new Cart() { CartId = 2, Customer = customer, CustomerId = 201, TotalPrice = 100, CartItems = cartItems };
        ...
        public void UpdateSuccessTest()
        {
            ...
            CartItem cartItem = new CartItem() { CartId = 2 };
            List<CartItem> cartItems = new List<CartItem>() { cartItem };
            Cart cart = new Cart() { CartId = 2, Customer = customer, CustomerId = 102, TotalPrice = 200, CartItems = cartItems };
