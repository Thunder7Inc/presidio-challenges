...
namespace ShoppingDALTest
{
    public class CartItemRepositoryTest
    {
        ...
        {
            Product product = new Product() { ProductId = 1, Price = 1000, Name = "Pencil", QuantityInHand = 4 };
        ...
        {
            // Arrange
            Product product1 = new Product() { ProductId = 1, Price = 1000, Name = "Pencil", QuantityInHand = 4 };
            Product product2 = new Product() { ProductId = 2, Price = 2000, Name = "Pen", QuantityInHand = 5 };
