...
{    
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //customerRepo.Add(new Customer { CustomerId = 1, Name = "Ramu", Age = 23 });
            //customerRepo.Add(new Customer { CustomerId = 2, Name = "Ramu", Age = 31 });
            //customerRepo.Add(new Customer { CustomerId = 3, Name = "Komu", Age = 27 });
